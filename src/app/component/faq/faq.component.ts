...
export class FAQComponent {
  faqs = [
    ...
    {
      question: 'I got an error when placing my order. What went wrong?',
      answer: 'Errors usually occur due to incorrect payment details, slow internet, or a temporary issue with the payment processor.Please double-check your billing address, card number, and available balance.If the issue continues, try using a different browser or payment method.You may also contact your bank to ensure the transaction is`t being blocked',
      open: false,
    },
    {
      question: 'I didn`t receive an order confirmation email.',
      answer: 'Order confirmation emails typically arrive within a few minutes.Check your spam, promotions, or junk folder just in case. If you still cannot find it, you may have entered an incorrect email.Contact customer support with your name and order details so we can resend your confirmation.',
      open: false,
    },
    {
      question: 'What if I can`t find what I am looking for?',
      answer: 'We offer a wide range of products, but if you cannot find a specific item, our support team can help check availability or suggest similar alternatives.Feel free to reach out through the chat widget or contact form anytime.',
      open: false,
    },
    {
      question: 'What type of products do you offer?',
      answer: 'We use a variety of quality products from carefully selected brands. Most apparel items are 100% cotton, and our catalog also includes 100% ethically sourced and eco–friendly products. Note that heathered colors and some specific clothing items are generally poly-blends. The specifics for each product type are listed in the “Product Details” section of the order screen. While we make every effort to provide a consistent product per run, hues and brands may vary due to supply chain availability but will be of comparable or better quality.',
      open: false,
    },
    {
      question: 'How does the clothing generally fit?',
      answer: 'Finding the right fit online can often be challenging. Take a glance at our size chart linked below the item selection area of the order screen. Women’s shirts such as Nano or Fitted have a slim, contoured fit. We recommend going up a size if a roomier fit is preferred. Please note that measurements may vary up to 1 inch (2.5 cm) due to manufacturing variances.',
      open: false,
    },
    {
...
You can click the link anytime to view your delivery status.
    ...
    {
      question: "I haven't received a shipment notification.",
      answer: `
...
If the status does not update after that, contact us and we will check with the carrier.
    ...
    {
      question: 'I need help with a late order.',
      answer: `
...
If your order is significantly late, contact us and we will investigate.
    ...
    {
      question: 'What can I do if I entered the wrong shipping address?',
      answer: `
...
Please contact us immediately with the correct information.
    ...
    {
      question: "My shirt doesn't fit. What do I do?",
      answer: `
...
GearLaunch is an e-commerce fulfillment platform that helps sellers produce and ship high-quality products worldwide.
    ...
    {
      question: 'How do I report a campaign for policy violations?',
      answer: `
If you believe a campaign violates policies, please contact customer support with the campaign link and details.
    ...
    {
      question: 'Do I need to enable cookies in my browser?',
      answer: `
